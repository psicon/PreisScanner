...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $ionicLoading, $state, $http, $stateParams, $ionicPopup, ProdukteService, SuchService,ShoppingCartService, DeviceService) {
	...
	//alert(DeviceService.getUuid() +"");
     ...
     template: '<p style="text-align:center;">Möchtest du jetzt  deinen Facebookfreunden von PreisScanner erzählen?</p>',
	 buttons: [
      { text: 'Später' },
      {
          ...
          openFB.api(
				{
					...
					path: '/me/feed',
					params: {
					message: "Coole App! Holt euch auch die App PreisScanner aus dem Appstore! " + news,
					 link: 'http://www.preisscanner.net',
					 application: 'geposted mit der PreisScanner App - jetzt im Appstore',
					 icon: 'http://www.psicon.de/preisscanner/img/icon.png'
					},
...
var responsePromise = $http.get("http://psicon.de/preisscanner/php/getnews.php",{timeout:20000});
                 responsePromise.success(function(data, status, headers, config) {
          ...
          openFB.api(
				{
					...
					path: '/me/feed',
					params: {
					message: "Coole App! Holt euch auch die App PreisScanner aus dem Appstore!",
					 link: 'http://www.preisscanner.net/',
					 application: 'geposted mit der PreisScanner App - jetzt im Appstore',
					 icon: 'http://www.psicon.de/preisscanner/img/icon.png'
					},
          ...
          openFB.api(
				{
					...
					message: posting+"",
					 link: 'http://www.preisscanner.net',
					 application: 'geposted mit der PreisScanenr App - jetzt im Appstore',
					 icon: 'http://www.psicon.de/preisscanner/img/icon.png',
					 picture: img1
					},
					success: $ionicPopup.alert({
